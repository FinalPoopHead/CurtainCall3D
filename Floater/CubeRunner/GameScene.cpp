...
constexpr flt::Vector2f HPPANEL_OFFSETPOS = { 0.9f,0.9f };
constexpr flt::Vector2f TIMEPANEL_OFFSETPOS = { 0.85f,0.08f };
constexpr flt::Vector2f SCOREPANEL_OFFSETPOS = { 0.15f,0.08f };

constexpr flt::Vector2f HPUISIZE = { 64.0f,64.0f };
...
void GameScene::Initialize()
{
	...
	constexpr float hpOffsetSize = 64.0f;
	int hpCount = 0;
