...
#pragma endregion
		RawAnimationClip() : RawAnimationClip(0.0f, 0.0f) {}
		RawAnimationClip(float startTime, float endTime) : startTime(startTime), endTime(endTime), keyPosition(), keyRotation(), keyScale() {}
